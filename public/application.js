...
var config = {
  apiOrigins: {
    production: 'https://guitartracker.herokuapp.com'
  }
};
...
var onCreateGuitar = function onCreateGuitar(event) {
  event.preventDefault();

  var data = getFormFields(event.target);

  api.createGuitar(data).then(ui.createGuitarSuccess).then(function () {
    return api.getGuitars(event);
  }).then(ui.getGuitarsSuccess).catch(ui.createGuitarFailure);
};

var onGetGuitars = function onGetGuitars(event) {
  event.preventDefault();

  api.getGuitars().then(ui.getGuitarsSuccess);
};

var onShowGuitar = function onShowGuitar(event) {
  event.preventDefault();

  dataId = $(event.target).attr('data-id');
  api.showGuitar(dataId).then(ui.showGuitarSuccess);
};

var populateUpdateData = function populateUpdateData(event) {
  event.preventDefault();

  var guitar = store.guitar;
...
var onUpdateGuitar = function onUpdateGuitar(event) {
  event.preventDefault();
  ...
  api.updateGuitar(dataId, updateData).then(ui.updateGuitarSuccess).then(function () {
    return api.getGuitars(event);
  }).then(ui.getGuitarsSuccess).catch(ui.updateGuitarFailure);
};

var onDeleteGuitar = function onDeleteGuitar() {
  dataId = store.guitar.id;

  var deletedGuitar = $('[data-id=' + dataId + ']');

  api.deleteGuitar(dataId).then($('#delete-modal').modal('toggle')).then($(deletedGuitar).fadeOut(1000)).then(ui.deleteGuitarSuccess).then(function () {
    return api.getGuitars(event);
  }).then(ui.getGuitarsSuccess).catch(ui.deleteGuitarFailure);
};

var onStuff = function onStuff() {
...
var userEvents = __webpack_require__(44);
var guitarEvents = __webpack_require__(9);
...
var onSignin = function onSignin(event) {
  ...
  api.signin(data).then(ui.signinSuccess).then(function () {
    return guitarEvents.onGetGuitars(event);
...
var signinSuccess = function signinSuccess(data) {
  ...
  $('#signup-signin').html('');
  var displayName = data.user.email.slice(1).split('@')[0];
...
var createGuitar = function createGuitar(data) {
  return $.ajax({
...
var showGuitar = function showGuitar(id) {
  return $.ajax({
...
var updateGuitar = function updateGuitar(id, data) {
...
var deleteGuitar = function deleteGuitar(id) {
  return $.ajax({
    url: config.apiOrigin + '/guitars/' + id,
    method: 'DELETE',
    headers: {
...
var showGuitarsTemplate = __webpack_require__(22);
var getGuitarTemplate = __webpack_require__(39);
var store = __webpack_require__(2);
__webpack_require__(40);
__webpack_require__(41);

var createGuitarSuccess = function createGuitarSuccess() {
...
var createGuitarFailure = function createGuitarFailure() {
  $('#createguitar').append('Create guitar FAILED SOMEHOW???');
  document.getElementById('createguitar').reset();
};

var getGuitarsSuccess = function getGuitarsSuccess(data) {
  var showGuitarsHTML = showGuitarsTemplate({ guitars: data.guitars });
...
var showGuitarSuccess = function showGuitarSuccess(data) {
  var getGuitarHTML = getGuitarTemplate({ guitar: data.guitar });
  $('#guitar-details').html(getGuitarHTML);

  store.guitar = data.guitar;
};

var updateGuitarSuccess = function updateGuitarSuccess() {
...
var updateGuitarFailure = function updateGuitarFailure() {
  $('body').append('Updated guitar FAILED Somehow???');
  document.getElementById('updateguitar').reset();
};

var deleteGuitarSuccess = function deleteGuitarSuccess() {
  $.toast({
    // text: '',
...
module.exports = {
  createGuitarSuccess: createGuitarSuccess,
  createGuitarFailure: createGuitarFailure,
  getGuitarsSuccess: getGuitarsSuccess,
  showGuitarSuccess: showGuitarSuccess,
  updateGuitarSuccess: updateGuitarSuccess,
  updateGuitarFailure: updateGuitarFailure,
  deleteGuitarSuccess: deleteGuitarSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <!-- TODO make the entirety of these divs (not including the buttons, which have their own functions) clickable\nby adding a class so that the enhanced view pops up for the guitar clicked on. Also add a message so users can know the divs are\nclickable, but the message should probably be in ui.js, not here-->\n\n  <div data-id=\""
    ...
    + "</h4>\n\n      <button data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "  data-toggle=\"modal\" data-target=\"#expand-modal\" class=\"btn btn-default btn-block expandButton\">See details</button>\n\n    </div>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.guitars : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div><label>Make: </label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.make : stack1), depth0))
    + "</div>\n<div><label>Model: </label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.model : stack1), depth0))
    + "</div>\n<div> <label>String brand:</label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.string_brand : stack1), depth0))
    + "</div>\n<div> <label> String gauge: </label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.string_guage : stack1), depth0))
    + "</div>\n<div> <label> Last string change:</label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.last_string_change : stack1), depth0))
    + "</div>\n<div> <label> Last setup: </label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.last_setup : stack1), depth0))
    + "</div>\n<div> <label>Setup notes: </label> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.guitar : depth0)) != null ? stack1.setup_notes : stack1), depth0))
    + "</div>\n<br>\n<br>\n<button data-toggle=\"modal\" data-target=\"#update-modal\" class=\"btn btn-info btn-block updateGuitarButton\">Update this guitar</button>\n<button data-toggle=\"modal\" data-target=\"#delete-modal\" class=\"btn btn-warning btn-block deleteGuitarButton\">Delete this guitar</button>";
},"useData":true});
...
var onGetUsers = function onGetUsers(event) {
  ...
  api.getUsers().then(ui.getUsersSuccess).catch(ui.getUsersFailure);
};
...
var getUsersFailure = function getUsersFailure(data) {
